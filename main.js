...
function setup() {
  ...
  var x3 = windowWidth / 2 - size / 10 * 4 + size / 10 * 8 / 20 + size / 10 * 8 / 10 * 0
  var y3 = windowHeight / 2 - size / 10 * 4 + size / 10 * 8 / 20 + size / 10 * 8 / 10 * 0
...
function draw() {
  ...
  if (gamestate === 'S1' || gamestate === 'S2' || gamestate === 'S3' || gamestate === 'S4' || gamestate === 'S5') {
    ...
    for(let i =  windowHeight / 2 - size / 10 * 4; i <= windowHeight / 2 + size / 10 * 4; i += size / 10 * 8 / 10){
      strokeWeight(2)
    ...
    for(let i =  windowWidth / 2 - size / 10 * 4; i <= windowWidth / 2 + size / 10 * 4; i += size / 10 * 8 / 10){
      strokeWeight(2)
      stroke(sin(h) * 200 + 100)
