  ...
  function makeBox(X, Y, m, t, d, c){ // s : movable  t : type  d : direction (1: up  2: right ...)
    ...
    var C 
    var x = windowWidth / 2 - size / 10 * 4 + size / 10 * 8 / 20 + size / 10 * 8 / 10 * X
    var y = windowHeight / 2 - size / 10 * 4 + size / 10 * 8 / 20 + size / 10 * 8 / 10 * Y
...
/*
  ...
  if(X === -1){
      x = windowWidth / 2 - size / 10 * 4
    } else if(X === 10){
      x = windowWidth / 2 + size / 10 * 4
    } else {
      x = windowWidth / 2 - size / 10 * 4 + size / 10 * 8 / 20 + size / 10 * 8 / 10 * X
    }
  ...
  var y
    ...
    if(Y === -1){
      y = windowHeight / 2 - size / 10 * 4
    } else if(Y === 10){
      y = windowHeight / 2 + size / 10 * 4
    } else {
      y = windowHeight / 2 - size / 10 * 4 + size / 10 * 8 / 20 + size / 10 * 8 / 10 * Y
    }
  ...
  for(let i = 0; i < 10; i += 1){
    if(X >= i * size / 10 * 8 / 10 + windowWidth / 2 - size / 10 * 4 && X <= (i + 1) * size / 10 * 8 / 10 + windowWidth / 2 - size / 10 * 4){
         x = i
       }
  }
  ...
  for(let i = 0; i < 10; i += 1){
    if(Y >= i * size / 10 * 8 / 10 + windowHeight / 2 - size / 10 * 4 && Y <= (i + 1) * size / 10 * 8 / 10 + windowHeight / 2 - size / 10 * 4){
         y = i
       }
  }
